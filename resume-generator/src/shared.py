...
def build_styles():
    ...
    styles.add(ParagraphStyle(
        name="Notice", fontSize=8, leading=10, fontName="Helvetica",
        textColor=ACCENT, alignment=TA_CENTER, spaceAfter=6,
    ))
    styles.add(ParagraphStyle(
        name="Name", fontSize=20, leading=24, textColor=PRIMARY,
        fontName="Helvetica-Bold", spaceAfter=2,
    ))
    styles.add(ParagraphStyle(
        name="TitleHeader", fontSize=11, leading=13, textColor=ACCENT,
        fontName="Helvetica-Bold", spaceAfter=6,
    ))
    styles.add(ParagraphStyle(
        name="Contact", fontSize=8.5, leading=11, textColor=GREY,
        fontName="Helvetica", spaceAfter=2,
    ))
    styles.add(ParagraphStyle(
        name="SectionHeader", fontSize=10.5, leading=13, textColor=PRIMARY,
        fontName="Helvetica-Bold", spaceBefore=10, spaceAfter=5,
    ))
    styles.add(ParagraphStyle(
        name="JobTitle", fontSize=10, leading=12, textColor=PRIMARY,
        fontName="Helvetica-Bold", spaceBefore=7, spaceAfter=1,
    ))
    styles.add(ParagraphStyle(
        name="Company", fontSize=9, leading=11, textColor=ACCENT,
        fontName="Helvetica", spaceAfter=3,
    ))
    styles.add(ParagraphStyle(
        name="BulletItem", fontSize=9, leading=12, textColor=TEXT,
        fontName="Helvetica", leftIndent=12, spaceAfter=1.5,
    ))
    styles.add(ParagraphStyle(
        name="Summary", fontSize=9, leading=12.5, textColor=TEXT,
        fontName="Helvetica", alignment=TA_JUSTIFY, spaceAfter=4,
    ))
    styles.add(ParagraphStyle(
        name="SkillLine", fontSize=8.5, leading=11, textColor=TEXT,
